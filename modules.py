...
def multihead_attention(queries,
    ...
    Args:
      ...
      attention_dropout_rate: A floating point number.
      residual_dropout_rate: A floating point number.
...
def residual(inputs, outputs, dropout_rate, is_training):
    ...
    Returns:
        A Tensor.
    """
    return inputs + tf.layers.dropout(outputs, rate=dropout_rate, training=is_training)
